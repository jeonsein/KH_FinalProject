    ...
    <div class="container">
        ...
        <div class="images">
            ...
            <ul class="sub_img" id="sub_img">
                <li><img src="/resources/images/${__INFO__.subimage1}" alt="메인이미지" onerror="this.src='/resources/images/${__INFO__.image}';"></li>
                <li><img src="/resources/images/${__INFO__.subimage2}" alt="메인이미지" onerror="this.src='/resources/images/${__INFO__.image}';"></li>
                <li><img src="/resources/images/${__INFO__.subimage3}" alt="메인이미지" onerror="this.src='/resources/images/${__INFO__.image}';"></li>
                <li><img src="/resources/images/${__INFO__.subimage4}" alt="메인이미지" onerror="this.src='/resources/images/${__INFO__.image}';"></li>
            </ul>
        </div>
            ...
            <div class="de1">
                ...
                <div class="p_repices_detail">
                    <c:forEach var="api" items="${__API__}" varStatus="status">
                        <div class="recipe_btn_${status.count}" id="recipeBtn">레시피${status.count}</div>
...
<script>
    ...
    window.addEventListener('load', () => {
        let num = Number("${__INFO__.disprice}").toLocaleString();
        console.log(num);  
